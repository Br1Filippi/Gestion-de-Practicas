...
class EstudianteCrearRequest extends FormRequest
{
    /**
    ...
    return [
        ...
        'rut_estudiante' => 'required|string|max:12|regex:/^\d{1,8}-[0-9kK]$/|unique:estudiantes,rut_estudiante|max:10|min:9',
...
public function messages(): array
{
    return [
        ...
        'imagen.max' => 'La imagen no puede ser mayor a 2048 kilobytes.',
        ...
        'rut_estudiante.regex' => 'El RUT no tiene un formato válido.',
        'rut_estudiante.unique' => 'El RUT ya está registrado.',
        'rut_estudiante.max' => 'El RUT no puede tener más de 10 caracteres.',
