            ...
            <div class="row mb-2 me-5">
                ...
                <div class="row mb-3 ">
                    <div class="col d-flex ">
                        <input type="text" name="termino" class="form-control" placeholder="Buscar Empresa">
                    </div>
                    ...
                    <div class="card mb-3 oferta-card shadow-sm ">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h4 class="mb-1"><strong>Rut empresa</strong></h4>
                                    <a href="">URL WEB</a>
                                    <div class="row">
                                        <div class="col">
                                            <p class="card-text mb-0"> Dirreccion</p>
                                        </div>
                                        <div class="col">
                                            <p class="card-text mb-0"> Razon Social</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <p class="card-text mb-0"> Email de Contacto</p>
                                        </div>
                                        <div class="col">
                                            <p class="card-text mb-0"> Email de Sesion</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <p class="card-text mb-0"> Cantidad de Ofertas</p>
                                        </div>
                                        <div class="col">
                                            <p class="card-text mb-0"> Cantidad de Supervisores</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-1">
