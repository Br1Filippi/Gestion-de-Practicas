        ...
        <div class="row w-100 ps-3">
            <div class="card custom-card shadow-sm" style="width: 80%;">
                <div class="card-body overflow-auto" style="max-height: 79vh;">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <p>{!! $practica->informe->actividades !!}</p>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <p> {!!$practica->informe->debilidades!!}</p>
                        </div>
                    </div>
                    <p class="mb-0"><strong>Fortalezas: </strong></p>
                    <div class="card">
                        <div class="card-body">
                            <p> {!!$practica->informe->fortalezas!!}</p>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <p> {!!$practica->informe->consideraciones!!}</p>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <p> {!!$practica->informe->sugerencias!!}</p>
                        </div>
                    </div>
