                    ...
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <div class="mb-3 mx-auto d-grid">
                                <a href="{{ route('usuarios.login') }}" class="btn btn-primary " role="button"
                                    aria-disabled="true" style="background-color: #005E90">Iniciar Sesion</a>
                            </div>

                            <p class="card-text">Cuentas empresas</p>
                            <div class="mb-3 mx-auto d-grid">
                                <button type="submit" class="btn text-white" style="background-color: #005E90">Crear
                                    Cuenta</button>
                            </div>
