            ...
            <div class="card text-center" style="width: 50%;">
                <div class="card-header bg-white shadow-sm mt-2 pb-3">
                    ...
                    <form method="POST" action="{{route('ofertas.store')}}">
                        ...
                        <div class="row mb-3">
                            <div class="col-4">
                                <select name="region" id="region-select" class="form-control" value="{{ old('region') }}">
                            ...
                            <div class="col-4">
                                <select name="comuna" id="comuna-select" class="form-control" value="{{ old('comuna') }}">
                        ...
                        <div class="col-4 mb-3">
                            <select name="carrera" class="form-control" value="{{ old('carrera') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-4 mb-3">
                                ...
                                <select name="tipo" class="form-control fs-6" value="{{ old('tipo') }}">
