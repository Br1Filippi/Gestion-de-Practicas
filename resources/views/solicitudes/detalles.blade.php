        ...
        <div class="card custom-card shadow-sm" style="width: 70%;">
            <div class="card-header shadow-sm">
                <div class="row">
                    ...
                    <p class="col-12 mt-0 mb-0">
                        ...
                        {{$solicitud->oferta->region->nombre}} / {{$solicitud->oferta->comuna->nombre}}
                    </p>
                    <p class="col-12 mb-0">
            ...
            <div class="card-body overflow-auto" style="max-height: 59vh;">
                ...
                <p>
                    ...
                    {{$solicitud->fecha_inicio}} <i class="material-icons" style="font-size: 1em">date_range</i>Fecha De
                    Termino: {{$solicitud->fecha_termino}}
                </p>
                <h4><strong>Datos de la Empresa</strong></h4>
                <p>
                    <i class="material-icons" style="font-size: 1em">business</i>
                    {{$solicitud->empresa->usuario->nombre}}
                </p>
                <p>
                ...
                <p>
                    ...
                    {{$solicitud->supervisor->usuario->nombre}} {{$solicitud->supervisor->usuario->apellido}}
                </p>
                <p>
                    <i class="material-icons" style="font-size: 1em">school</i>
                    {{$solicitud->supervisor->titulo_supervisor}} / <i class="material-icons"
                        style="font-size: 1em">work</i>{{$solicitud->supervisor->cargo_supervisor}}
                </p>
                <p>
                ...
                <p>
                    ...
                    {{$solicitud->estudiante->rut_estudiante}} / {{$solicitud->estudiante->edad_estudiante}} años
                </p>
                <p>
                    <i class="material-icons" style="font-size: 1em">phone</i>
                    {{$solicitud->estudiante->fono_estudiante}} / <i class="material-icons"
                        style="font-size: 1em">home</i> {{$solicitud->estudiante->direccion_estudiante}}
                </p>
                <p>
                    <i class="material-icons" style="font-size: 1em">school</i>
                    {{$solicitud->estudiante->carrera->nombre}}
                </p>
                @endif
            </div>
            @if (Gate::allows('jefe-gestion') or Gate::allows('secretaria-gestion'))
            <div class="card-footer d-flex justify-content-end align-items-end">
                ...
                <form action="{{route('practicas.store',$solicitud->id)}}" method="POST">
                    @csrf
                    <button type="submit"
                        class="btn text-white btn-success mx-2 d-flex justify-content-center align-items-center">
                        <i class="material-icons text-white mx-1" style="font-size: 1em">check</i>
