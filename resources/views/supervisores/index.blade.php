                    ...
                    <div class="card mb-3 oferta-card shadow-sm ">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h4 class="mb-1"><strong>Supervisor 1</strong></h4>
                                    <p class="card-text mb-0"> Rut:</p>
                                    <p class="card-text mb-0"> Fono:</p>
                                    <div class="row mb-0">
                                        <div class="col-4 mb-0">
                                            <p class="mb-1">Ttitulo:</p>
                                        </div>
                                        <div class="col-4 mb-0">
                                            <p class="mb-1">Cargo: </p>
                                        </div>
                                    </div>
                                    <p class="card-text mb-0 mt-0"> cantidad de practicantes a su cargo:</p>
                                </div>
                                <div class="col-1">
                    ...
                    <div class="card mb-3 oferta-card shadow-sm ">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h4 class="mb-1"><strong>Supervisor 2</strong></h4>
                                    <p class="card-text mb-0"> Rut:</p>
                                    <p class="card-text mb-0"> Fono:</p>
                                    <div class="row mb-0">
                                        <div class="col-4 mb-0">
                    ...
                    <div class="card mb-3 oferta-card shadow-sm ">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h4 class="mb-1"><strong>Supervisor 3</strong></h4>
                                    <p class="card-text mb-0"> Rut:</p>
                                    <p class="card-text mb-0"> Fono:</p>
                                    <div class="row mb-0">
                                        <div class="col-4 mb-0">
                    ...
                    <div class="card mb-3 oferta-card shadow-sm ">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h4 class="mb-1"><strong>Supervisor 4</strong></h4>
                                    <p class="card-text mb-0"> Rut:</p>
                                    <p class="card-text mb-0"> Fono:</p>
                                    <div class="row mb-0">
                                        <div class="col-4 mb-0">
