...
<body class="d-flex">
    <nav class="navbar navbar-expand-lg navbar-dark flex-column vh-100 p-3" style="width: 250px; background-color: #005E90;">
        {{-- Logo USM  --}}
        ...
        <div class="collapse navbar-collapse flex-column d-flex justify-content-between h-100 w-100" id="navbarNav">
            <ul class="navbar-nav flex-column w-100 mb-4">
                ...
                <li class="nav-item mb-3 rounded" onmouseover="this.classList.add('bg-secondary')"onmouseout="this.classList.remove('bg-secondary')">
            ...
            <ul class="navbar-nav flex-column w-100 mt-auto ">
                <li class="nav-item py-0 bg-transparent border-0">
                    <div class="d-flex align-items-center justify-content-between rounded" onmouseover="this.classList.add('bg-secondary')"onmouseout="this.classList.remove('bg-secondary')">
                        <a class="nav-link text-white d-flex fs-4 py-4" href="#">
                            <span class="material-icons me-2 fs-3">person</span>
                            Perfil
                        </a>
                        <a href="{{ route('usuarios.logout') }}" class="btn btn-sm btn-danger d-flex align-items-center">
